...
__DATA__
# URL, Title, Active (2 - Unknown, 1 - Active, 0 - Not active), Functionality (2 - Unknown, 1 - Failed, 0 - Functional)
...
https://classic.scraperwiki.com/scrapers/average_daily_water_consumption_in_brno_in_liters_/,Average daily water consumption in Brno,0,1
...
https://morph.io/soit-sk/brno_average_daily_water_consumption_in_liters,1,0
